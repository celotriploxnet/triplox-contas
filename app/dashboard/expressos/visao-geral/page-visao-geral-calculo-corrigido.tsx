...
function toNumber(v: any) {
  ...
  if (hasComma && hasDot) {
    ...
    // 1.234 ou 1.234.567 => 1234 / 1234567
...
function calcPontosAtualizado(d: any) {
  // A Visão Geral deve recalcular os pontos sempre pela regra atual.
  // Assim ela não fica presa a pontos antigos/salvos antes da correção.
      ...
      <section style={styles.hero}>
        <div>
          ...
          <p style={styles.subtitle}>
            Resumo executivo usando a nova regra de pontuação e recalculando os pontos direto pela base Junho.
          </p>
        </div>

...
const perguntasFrequentes: Pergunta[] = [
  ...
  },
  {
    ...
    resposta:
      "A busca pode ser feita pelo Portal Bradesco Dental ou pelo aplicativo Bradesco Seguros, onde também ficam disponíveis a carteirinha digital, a consulta de cobertura e os canais de atendimento.",
  },
  {
    ...
    <main className={styles.page}>
      ...
      <section className={styles.content}>
        ...
        <section className={styles.supportSection}>
          <article>
            <span>Aplicativo e portal</span>
            <h3>Serviços disponíveis</h3>
            <p>
              Carteirinha digital, busca de dentistas, consulta de cobertura,
              canais de atendimento e Clube de Vantagens.
            </p>
          </article>
